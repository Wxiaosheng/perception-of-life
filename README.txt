...
最终线上的链接为：
  https://wxiaosheng.github.io/perception-of-life/

语法：
  index.html 中的 window.$docsify 配置
  

  设置封面
    1、在 window.$docsify 中配置 coverpage: true 开启封面
    2、在项目根目录创建 _coverpage.md 文件，注意，只根目录下才有封面，其他层级下没有
  

  开启顶部导航栏
    1、在 window.$docsify 中配置 loadNavbar: true 开启顶部导航栏
    2、在项目根目录创建 _navbar.md文件，内容如下：
      * [前端]](fore/)
      * [后端](back/)
      * [投资](investment/)
    3、导航栏嵌套，内容如下：
  ...
  左侧导航栏
    1、在 window.$docsify 中配置 loadSidebar: true 开启左侧导航栏
    2、在项目根目录创建_ sidebar.md 文件，内容格式如下：
  ...
  封面
    1、在 window.$docsify 中配置 coverpage: true, 开启封面
      ...
      <!-- 背景色 -->
      ![color](#2f4253)
    2、把封面作为首页，配置了封面后，封面和首页是同时出现的，封面在上面，首页在下面
